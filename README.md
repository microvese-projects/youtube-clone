...
**Youtube Clone** is a project that was created as part of the Microverse Application requirements.

## 🛠 Built With <a name="built-with"></a>

### Tech Stack <a name="tech-stack"></a>

This project was created in HTML and CSS.
...
```sh
  mkdir my-folder
  cd my-folder
  git clone git@github.com:microvese-projects/youtube-clone.git
```
-
...
Feel free to check the [issues page](https://github.com/microvese-projects/youtube-clone/issues).
...
This project is [MIT](https://github.com/microvese-projects/youtube-clone/blob/c25bd64f117b97de30d4fde8378ec04d78bebeb2/LICENSE.md) licensed.
